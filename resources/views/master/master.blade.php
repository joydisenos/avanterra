...
<aside class="admin-sidebar">
    <div class="admin-sidebar-brand">
        ...
        <span class="admin-brand-content"><a href="{{ route('index') }}">  {{ env('APP_NAME') }}</a></span>
    ...
    <div class="admin-sidebar-wrapper js-scrollbar">
        ...
        <li class="menu-item active">
            ...
            <li class="menu-item active">
                <a href="{{ route('comercial') }}" class="menu-link">
                        <span class="menu-label">
                                                 <span class="menu-name">Comercial
                                                </span>
                                            </span>
                    <span class="menu-icon">
                                                   <!--<span class="icon-badge badge-success badge badge-pill">1</span>-->
            ...
            @role('financiero|admin')
            <!--list item begins-->
            <li class="menu-item active">
                <a href="{{ route('financiero') }}" class="menu-link">
                        <span class="menu-label">
                                                 <span class="menu-name">Financiero
                                                </span>
                                            </span>
                    <span class="menu-icon">
                                                   <!--<span class="icon-badge badge-success badge badge-pill">1</span>-->
